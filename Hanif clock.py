...
## Class for drawing a simple analog clock.5
#
class clock:
    ## Constructor.
    #
    ...
    def __init__(self,root,deltahours = 0,sImage = True,w = 400,h = 400,useThread = False):
        self.world       = [-1,-1,1,1]
        self.imgPath     = 'Bg.jpg'  # image path
    ...
    def painthms(self):
        ...
        scl(self.T.windowToViewport(0,0,x,y), fill = self.timecolor, tag=self._ALL)
...
def main(argv=None):
    ...
    lbl = Label(root, text="Lil h_b", font=("Arial, 10"), bg="Black", fg="white")
    lbl.pack()
    root.mainloop()
